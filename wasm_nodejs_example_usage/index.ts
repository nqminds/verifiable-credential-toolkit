...
check("an expired credential is rejected", verify(expired, verifyingKey) === false);
const notYetValid = sign({ ...baseVC, validFrom: "2999-01-01T00:00:00Z" }, signingKey);
check("a not-yet-valid credential is rejected", verify(notYetValid, verifyingKey) === false);
