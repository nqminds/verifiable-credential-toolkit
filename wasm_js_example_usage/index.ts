// Browser example — exercises the JSON-object WASM API surface and reports each
// result on the page. (The CBOR / Protobuf byte APIs are demonstrated in the
// Node example, which can load binary fixtures from disk.)
//
